...
public class ColorPickerDialog extends Dialog {
     ...
     * @param listener 回调
     */
    public ColorPickerDialog(int c, int a, float s, Context context, int initialColor, 
    		String title, OnColorChangedListener listener) {
        super(context);
        this.context = context;
        mListener = listener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		ll = (LinearLayout)findViewById(R.id.set_brush);
		ll.addView(myView);
		brushAlpha = (SeekBar)findViewById(R.id.alpha);
		brushWidth = (SeekBar)findViewById(R.id.width);
		
		brushAlpha.setProgress(255-alpha);
		brushAlpha.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar,
				...
				if (progress > 0) {
					if (fromUser) {
						//panel.bradius = seekBar.getProgress();
						mListener.alphaChanged(seekBar.getProgress());
					}
				} else {
		...
		brushWidth.setProgress((int)size);
